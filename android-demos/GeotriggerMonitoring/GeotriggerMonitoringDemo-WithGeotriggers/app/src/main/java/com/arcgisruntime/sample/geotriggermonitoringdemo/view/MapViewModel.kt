...
import com.arcgisruntime.sample.geotriggermonitoringdemo.domain.GeotriggerInteractor
...
class MapViewModel @Inject constructor(
    ...
    private val geotriggerInteractor: GeotriggerInteractor
) : ViewModel() {
    ...
    val shouldMonitor = geotriggerInteractor.shouldMonitor
    val locationDataSource: LocationDataSource = geotriggerInteractor.lds
    ...
    fun startMonitoring() {
        geotriggerInteractor.createMonitors(graphicsOverlay, 50.0)
        viewModelScope.launch(Dispatchers.Main) {
            geotriggerInteractor.setMonitoring(true)
        }
    }
