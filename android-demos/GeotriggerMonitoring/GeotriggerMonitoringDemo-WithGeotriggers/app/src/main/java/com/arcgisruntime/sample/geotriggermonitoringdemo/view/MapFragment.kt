...
import com.arcgisruntime.sample.geotriggermonitoringdemo.domain.GeotriggerMonitoringService
...
class MapFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.mapView.apply {
            ...
            locationDisplay.locationDataSource = mViewModel.locationDataSource
            onTouchListener =
        ...
        binding.monitorButton.setOnClickListener {
            (activity as MainActivity).startMonitoringService()
